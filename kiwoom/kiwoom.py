...
class Kiwoom(QAxWidget):
    ...
    def detail_account_mystock(self, sPrevNext="0"):
        print("계좌평가 잔고내역 요청하기 연속조호 %s" % sPrevNext)
        ...
        if sRQName == "계좌평가잔고내역요청":
            ...
            if sPrevNext == "2":
                ...
                if self.calcul_data == None or len(self.calcul_data) < 120:
                    ...
                    # 일봉 데이터들이 120일 이평선보다 위에 있으면 계산 진행
                    ...
                    if bottom_stock_price == True:
                        ...
                        while True:
                            ...
                            elif int(self.calcul_datap[idx][7]) > moving_average_price_prev and idx > 20:
                        ...
                        if price_top_moving == True:
                            if moving_average_price > moving_average_price_prev and check_price > prev_price:
                                print("포착된 이평선의 가격이 오늘자(최근일자) 이평선 가격보다 맞은 것 확인됨")
    ...
    def realdata_slot(self, sCode, sRealType, sRealData):
        ...
        if sRealType == "장시작시간":
            ...
            d = self.dynamicCall("GetCommRealData(QString, int)", sCode, self.realType.REALTYPE[sRealType]['전일대비'])  # 출력 +(-)12.98
            d = float(int(d))
            ...
            g = self.dynamicCall("GetCommRealData(QString, int)", sCode, self.realType.REALTYPE[sRealType]['거래량'])  # 출력 +(-)2515
            g = abs(int(g))
            ...
            if sCode in self.account_stock_dict.keys() and sCode not in self.jango_dict.keys():
                ...
                if asd['매입가능수량'] > 0 and (meme_rate > 5 or meme_rate < -5):
                    ...
                    order_succes = self.dynamicCall("SendOrder(QString, QString, QString, int, QString, int, int, QString, QString)",
                                 ["신규매도", self.portfolio_stock_dict['주문용스크린번호'], self.account_num, 2,
    ...
    def chejan_slot(self, sGubun, nItemCnt, sFIdList):
        ...
        if int(sGubun) == 0: #주문체결
            ...
            self.not_account_stock_dict[order_number].update({"현재가": chegual_price})
